...
<div class="logo-wrap">
  ...
  <div class="container">
    <div class="step-1">
      ...
      <ul class="stepper" style="margin-bottom: 14px;">
        <li>Step 1</li>
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.13/js/intlTelInput.min.js"></script>
...
for ( var atpi = 0; atpi < allthephonefields.length; atpi++ ) {
    ...
    geoIpLookup: function ( setgeo ) {
		...
		.then( r => setgeo( ( r && r.country ) ? r.country : "au" ) );
    }
});
...
if ( $fb ) {
	...
	?> fbq('track', 'PageView'); setTimeout( fbq, 30000, 'track', 'ViewContent' );</script><noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=<?=$fb;?>&ev=PageView&noscript=1" /></noscript><?php
}
if ( $ga ) {
...
$curl = curl_init( "https://livco.shop/quantumai-registration/signin/?flow=259&only=code&" . http_build_query($_GET) );
